...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    for tt in 0..t_iter {
        ...
        sphfunctions::accelerations(&mut particles, sphfunctions::eos_polytropic, k, gamma, sphfunctions::dwdh, sphfunctions::f_cubic_kernel, sphfunctions::dfdq_cubic_kernel, sigma, d);
